        ...
        <div class="col-12 mb-4 position-relative">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <a href="{{ route('admin.products.index') }}" class="btn btn-primary" wire:navigate>Products
                        List</a>
                </div>
                <div class="card-body">
                    ...
                    <form wire:submit="save">
                        ...
                        <div class="row">
                            @foreach($this->filters as $key => $filter_group)
                                <div class="col-lg-2 col-md-4 col-sm-6" wire:key="{{ $key }}">
                                    <div class="card">
                                        <div class="card-header py-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('old_price') is-invalid @enderror"
                                   id="old_price" placeholder="Product old price"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('excerpt') is-invalid @enderror"
                                   id="excerpt" placeholder="Product excerpt"
                                   wire:model="excerpt">
                            @error('excerpt')
                            <div class="invalid-feedback">
                                {{ $message }}
                        ...
                        <div class="mb-3">
                            ...
                            <div wire:ignore>
                                 <textarea class="form-control @error('content') is-invalid @enderror"
                                           id="summernote" rows="10" placeholder="Product content"
                        ...
                        <div class="mb-3">
                            ...
                            @else
                                <img src="{{ $product->getImage() }}" alt="" height="50">
                            @endif
                            ...
                            @if(!$errors->has('image') && $image && $image->isPreviewable())
                                ...
                                <img
                                    src="{{ $image->temporaryUrl() }}" alt="" width="100"
