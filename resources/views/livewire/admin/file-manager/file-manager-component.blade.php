<div>
    ...
    <a href="#" type="button" class="btn btn-primary" data-toggle="modal" data-target="#fileManager">
        FileManager
    </a>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="fileManagerLabel">FileManager</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        @if(!$errors->has('path') && $path && $path->isPreviewable())
                            ...
                            <img
                                src="{{ $path->temporaryUrl() }}" alt="" width="100"
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            @foreach($media as $item)
                                <tr wire:key="{{ $item->id }}">
                                    <td>{{ ($media->currentPage() - 1) * $media->perPage() + $loop->iteration }}</td>
                                    ...
                                    <td>
                                        <div x-data="{ input: '{{ asset($item->path) }}', showMsg: false }">
                                            <div class="overflow-hidden">
                                                ...
                                                <a @click="navigator.clipboard.writeText(input), showMsg = true,
